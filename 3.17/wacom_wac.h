...
#define WACOM_PKGLEN_IP2_USB	192 /* pen/buttons/touchring/status endpoint, 0x81 */

/* wacom data size per MT contact */
#define WACOM_BYTES_PER_MT_PACKET	11
#define WACOM_BYTES_PER_24HDT_PACKET	14
#define WACOM_BYTES_PER_QHDTHID_PACKET	 6
#define WACOM_BYTES_PER_IP2_PACKET	44 /* touch endpoint, 0x85 */
...
#define WACOM_REPORT_IP2_STATUS	0x13 /* 19 */
#define WACOM_REPORT_IP2_TOUCH	0x21 /* 33 */
#define WACOM_REPORT_IP2_BTN	0x11 /* 17 */
#define WACOM_REPORT_IP2_PEN	0x10 /* 16 */
...
/* IP2 CONTACTMAX is 0xff000055 instead of 0x000d0055 */
#define WACOM_HID_DG_CONTACTMAX         (HID_UP_MSVENDOR | (HID_USAGE & HID_DG_CONTACTMAX))
...
#define WACOM_HID_WD_EXPRESSKEYCAP01    (WACOM_HID_UP_WACOMDIGITIZER | 0x0940)
